...
return (new CustomEvent(event_name,(function (){var obj43280 = ({"detail":data});
return obj43280;
})()));
} else {
...
var f = (function (){var pred__43287 = cljs.core._EQ_;
var expr__43288 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__43287.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__43288))){
return (function (p1__43281_SHARP_){
return console.warn(p1__43281_SHARP_);
});
} else {
if(cljs.core.truth_(pred__43287.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__43288))){
return (function (p1__43282_SHARP_){
return console.debug(p1__43282_SHARP_);
});
} else {
if(cljs.core.truth_(pred__43287.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__43288))){
return (function (p1__43283_SHARP_){
return console.error(p1__43283_SHARP_);
});
} else {
return (function (p1__43284_SHARP_){
return console.log(p1__43284_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__43291){
var map__43292 = p__43291;
var map__43292__$1 = (((((!((map__43292 == null))))?(((((map__43292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43292.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43292):map__43292);
var opts = map__43292__$1;
var eval_fn = cljs.core.get.call(null,map__43292__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__43294_SHARP_){
return new_def.callback(p1__43294_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__43295){
var vec__43296 = p__43295;
var ky = cljs.core.nth.call(null,vec__43296,(0),null);
...
}catch (e43301){if((e43301 instanceof Error)){
var e = e43301;
return not_found;
} else {
throw e43301;
...
//# sourceMappingURL=utils.js.map?rel=1608009995277
