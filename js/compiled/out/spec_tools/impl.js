...
var vec__28767 = cljs.core.rest.call(null,expr);
...
var vec__28770 = first__28769;
var s = cljs.core.nth.call(null,vec__28770,(0),null);
var form = seq__28768__$1;
...
var G__28773 = x;
var G__28773__$1 = (((G__28773 == null))?null:spec_tools.impl.polish.call(null,G__28773));
var G__28773__$2 = (((G__28773__$1 == null))?null:cljs.core.name.call(null,G__28773__$1));
if((G__28773__$2 == null)){
return null;
} else {
return cljs.core.keyword.call(null,G__28773__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__28774 = x;
var G__28774__$1 = (((G__28774 == null))?null:cljs.core.name.call(null,G__28774));
if((G__28774__$1 == null)){
return null;
} else {
return cljs.core.keyword.call(null,G__28774__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__28775){
...
var data = map__28776__$1;
var req = cljs.core.get.call(null,map__28776__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.call(null,map__28776__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.call(null,map__28776__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.call(null,map__28776__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__28778){
...
var data = map__28779__$1;
var req_un = cljs.core.get.call(null,map__28779__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__28779__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__28781 = data;
var G__28781__$1 = (cljs.core.truth_(req_un)?cljs.core.update.call(null,G__28781,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.call(null,cljs.core.mapv,spec_tools.impl.un_key)):G__28781);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.call(null,G__28781__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.call(null,cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__28781__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__28785 = form;
var G__28785__$1 = (((G__28785 == null))?null:cljs.core.rest.call(null,G__28785));
if((G__28785__$1 == null)){
return null;
} else {
return cljs.core.apply.call(null,cljs.core.hash_map,G__28785__$1);
}
})();
var G__28786 = m;
var G__28786__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__28786,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__28782_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,cljs.core.flatten.call(null,p1__28782_SHARP_)));
})):G__28786);
var G__28786__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__28786__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__28783_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,cljs.core.flatten.call(null,p1__28783_SHARP_)));
})):G__28786__$1);
var G__28786__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__28786__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__28784_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,p1__28784_SHARP_));
})):G__28786__$2);
return spec_tools.impl.with_real_keys.call(null,spec_tools.impl.with_key__GT_spec.call(null,G__28786__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__28787 = (function (){var G__28788 = form;
var G__28788__$1 = (((G__28788 == null))?null:cljs.core.rest.call(null,G__28788));
if((G__28788__$1 == null)){
return null;
} else {
return cljs.core.apply.call(null,cljs.core.hash_map,G__28788__$1);
}
})();
...
var req = cljs.core.get.call(null,map__28787__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.call(null,map__28787__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.call(null,map__28787__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__28787__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__28790 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace.call(null,kw):false);
switch (G__28790) {
...
return cljs.core.boolean$.call(null,((cljs.core.seq_QMARK_.call(null,form))?(function (){var G__28792 = form;
var G__28792__$1 = (((G__28792 == null))?null:cljs.core.seq.call(null,G__28792));
var G__28792__$2 = (((G__28792__$1 == null))?null:cljs.core.first.call(null,G__28792__$1));
if((G__28792__$2 == null)){
return null;
} else {
return new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null).call(null,G__28792__$2);
}
})():null));
});
/**
...
var len__4736__auto___28794 = arguments.length;
var i__4737__auto___28795 = (0);
while(true){
if((i__4737__auto___28795 < len__4736__auto___28794)){
args__4742__auto__.push((arguments[i__4737__auto___28795]));

var G__28796 = (i__4737__auto___28795 + (1));
i__4737__auto___28795 = G__28796;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq28793){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28793));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.call(null,(function (acc,p__28797){
var vec__28798 = p__28797;
var k = cljs.core.nth.call(null,vec__28798,(0),null);
var v = cljs.core.nth.call(null,vec__28798,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__28803){
...
var req = cljs.core.get.call(null,map__28804__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.call(null,map__28804__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.call(null,map__28804__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__28804__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__28801_SHARP_){
return cljs.core.map_QMARK_.call(null,p1__28801_SHARP_);
})], null),cljs.core.map.call(null,(function (x){
return (function (p1__28802_SHARP_){
return cljs.core.contains_QMARK_.call(null,p1__28802_SHARP_,x);
});
}),req_keys));
...
//# sourceMappingURL=impl.js.map?rel=1608011913338
