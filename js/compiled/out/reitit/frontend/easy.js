...
cljs.core.swap_BANG_.call(null,reitit.frontend.easy.history,reitit.frontend.history.stop_BANG_);

return reitit.frontend.history.start_BANG_.call(null,router,(function reitit$frontend$easy$start_BANG__$_rfe_on_navigate(m,this$){
if((cljs.core.deref.call(null,reitit.frontend.easy.history) == null)){
cljs.core.reset_BANG_.call(null,reitit.frontend.easy.history,this$);
} else {
}

return on_navigate.call(null,m,this$);
}),opts);
});
...
//# sourceMappingURL=easy.js.map?rel=1608011917338
